...
5. Siguiente: EMA Cloud (dos EMAs formando una nube — puede reusar el mismo patrón de panel con dos líneas, o esperar a decidir sobre overlays)
6. (resto — Bollinger, Ichimoku, VWAP Anclado, Acum/Distrib., Heikin Ashi Semanal, Patrones de velas, Fuerza relativa, Setup Beardo, Soportes/Resistencias)
